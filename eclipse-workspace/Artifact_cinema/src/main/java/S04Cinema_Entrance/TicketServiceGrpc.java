...
/**
 * <pre>
 * this rpc is for managing ticket admissions
 * </pre>
 */
@javax.annotation.Generated(
    value = "by gRPC proto compiler (version 1.15.0)",
    comments = "Source: S04.proto")
public final class TicketServiceGrpc {

  private TicketServiceGrpc() {}

  public static final String SERVICE_NAME = "Artifact_cinema.TicketService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<S04Cinema_Entrance.TicketRequest,
      S04Cinema_Entrance.TicketResponse> getAdmitTicketsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AdmitTickets",
      requestType = S04Cinema_Entrance.TicketRequest.class,
      responseType = S04Cinema_Entrance.TicketResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<S04Cinema_Entrance.TicketRequest,
      S04Cinema_Entrance.TicketResponse> getAdmitTicketsMethod() {
    io.grpc.MethodDescriptor<S04Cinema_Entrance.TicketRequest, S04Cinema_Entrance.TicketResponse> getAdmitTicketsMethod;
    if ((getAdmitTicketsMethod = TicketServiceGrpc.getAdmitTicketsMethod) == null) {
      synchronized (TicketServiceGrpc.class) {
        if ((getAdmitTicketsMethod = TicketServiceGrpc.getAdmitTicketsMethod) == null) {
          TicketServiceGrpc.getAdmitTicketsMethod = getAdmitTicketsMethod = 
              io.grpc.MethodDescriptor.<S04Cinema_Entrance.TicketRequest, S04Cinema_Entrance.TicketResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Artifact_cinema.TicketService", "AdmitTickets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  S04Cinema_Entrance.TicketRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  S04Cinema_Entrance.TicketResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new TicketServiceMethodDescriptorSupplier("AdmitTickets"))
                  .build();
          }
        }
     }
     return getAdmitTicketsMethod;
  }
  ...
  public static abstract class TicketServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     * <pre>
     * Client streaming method for ticket admission
     * </pre>
     */
    public io.grpc.stub.StreamObserver<S04Cinema_Entrance.TicketRequest> admitTickets(
        io.grpc.stub.StreamObserver<S04Cinema_Entrance.TicketResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getAdmitTicketsMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getAdmitTicketsMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                S04Cinema_Entrance.TicketRequest,
                S04Cinema_Entrance.TicketResponse>(
                  this, METHODID_ADMIT_TICKETS)))
          .build();
    }
  }
  ...
  public static final class TicketServiceStub extends io.grpc.stub.AbstractStub<TicketServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<S04Cinema_Entrance.TicketRequest> admitTickets(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getAdmitTicketsMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_ADMIT_TICKETS = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_ADMIT_TICKETS:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.admitTickets(
              (io.grpc.stub.StreamObserver<S04Cinema_Entrance.TicketResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class TicketServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return S04Cinema_Entrance.Serv04Cinema_Entrance.getDescriptor();
    }
      ...
      synchronized (TicketServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getAdmitTicketsMethod())
              .build();
        }
      }
    }
