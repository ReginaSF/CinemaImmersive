...
@javax.annotation.Generated(
    ...
    comments = "Source: S1_SeatHeating.proto")
public final class CinemaImmersiveGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<S01SeatHeating.ActivateRequest,
      S01SeatHeating.ActivateResponse> getActivateHeatingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ActivateHeating",
      requestType = S01SeatHeating.ActivateRequest.class,
      responseType = S01SeatHeating.ActivateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<S01SeatHeating.ActivateRequest,
      S01SeatHeating.ActivateResponse> getActivateHeatingMethod() {
    io.grpc.MethodDescriptor<S01SeatHeating.ActivateRequest, S01SeatHeating.ActivateResponse> getActivateHeatingMethod;
      ...
      synchronized (CinemaImmersiveGrpc.class) {
        if ((getActivateHeatingMethod = CinemaImmersiveGrpc.getActivateHeatingMethod) == null) {
          CinemaImmersiveGrpc.getActivateHeatingMethod = getActivateHeatingMethod = 
              io.grpc.MethodDescriptor.<S01SeatHeating.ActivateRequest, S01SeatHeating.ActivateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CinemaIntelligent.CinemaImmersive", "ActivateHeating"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  S01SeatHeating.ActivateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  S01SeatHeating.ActivateResponse.getDefaultInstance()))
  ...
  public static abstract class CinemaImmersiveImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void activateHeating(S01SeatHeating.ActivateRequest request,
        io.grpc.stub.StreamObserver<S01SeatHeating.ActivateResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                S01SeatHeating.ActivateRequest,
                S01SeatHeating.ActivateResponse>(
  ...
  public static final class CinemaImmersiveBlockingStub extends io.grpc.stub.AbstractStub<CinemaImmersiveBlockingStub> {
     ...
     * </pre>
     */
    public S01SeatHeating.ActivateResponse activateHeating(S01SeatHeating.ActivateRequest request) {
  ...
  public static final class CinemaImmersiveFutureStub extends io.grpc.stub.AbstractStub<CinemaImmersiveFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<S01SeatHeating.ActivateResponse> activateHeating(
        S01SeatHeating.ActivateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ACTIVATE_HEATING:
          serviceImpl.activateHeating((S01SeatHeating.ActivateRequest) request,
              (io.grpc.stub.StreamObserver<S01SeatHeating.ActivateResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CinemaImmersiveBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return S01SeatHeating.Serv01SeatHeating.getDescriptor();
    }
