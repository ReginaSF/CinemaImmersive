...
public class MqttPublishSample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			publishMessage("/house/power", LocalDateTime.now()+ "the power is down! immediate action is required", 2, false);

			publishMessage("/house/water", LocalDateTime.now()+ "house water is on", 1, false);

			publishMessage("/house",LocalDateTime.now() + "general house info", 1, false);

			publishMessage("/garden/water", LocalDateTime.now() + "garden water is off", 1, false);
